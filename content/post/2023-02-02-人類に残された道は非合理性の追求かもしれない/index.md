...
[ChatGPTの登場](#chatgptの登場) を受け、試しに[ChatGPT](https://openai.com/blog/chatgpt/)をコンシェルジュ的な立ち位置に置いて開発をしてみたのです。すると、無事に組み上がるわけです。私は「あれ・・ほぼ到来しちゃったんじゃ・・」と感じているのです。hahaha。  

これまで[Google](https://www.google.com/)で探し回っていたことが、チャットに聞けば「短時間で合理的且つ実用的な返答をする」ということです。「中に人がいるのでは？」と疑うくらい「文脈・行間」を読んだ上での返答があるのです。[Google LLC](https://about.google/)が「コードレッド」を宣言されたのも頷けます。  
